                            ...
                            <form action="/Servlet" method="post">
                                <div class="input-group input-group-newsletter">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit" name="act" val="search">Search</button>
                                    </div>
                                </div>
                                <br/>
                                <div class="input-group input-group-newsletter">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit" name="act" val="delete">Delete</button>
                                    </div>
                                </div>
                                <br/>
                                <div class="input-group input-group-newsletter">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit" name="act" val="update">Update</button>
                                    </div>
                                    <br/>
                                </div>
                                <br/>
                                <div class="input-group input-group-newsletter">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-secondary" type="submit" name="act" val="insert">Insert</button>
                                    </div>
                            </form>
                        </div>
                    </div>
